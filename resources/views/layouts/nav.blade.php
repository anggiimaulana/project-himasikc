<header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-14 border-b border-gray-200"
        ...
        <div class="navbar hidden lg:flex lg:gap-x-12">
            <a nav-link {{ $slug === 'home' ? 'active' : '' }}" aria-current="page" href="/"
                class=" font-semibold
                text-gray-700 flex items-center gap-x-1 hover:text-gray-950">
                <i class='bx bx-home-alt text-xl'></i>
                <p>Beranda</p>
            </a>
            <a nav-link {{ $slug === 'profil' ? 'active' : '' }}" aria-current="page" href="/app/profil"
                class=" font-semibold text-gray-700 flex items-center gap-x-1 hover:text-gray-950">
                <i class='bx bxs-user-detail text-xl'></i>
                <p>Profil</p>
            </a>
            <a nav-link {{ $slug === 'program' ? 'active' : '' }}" aria-current="page" href="/app/program"
                class=" font-semibold text-gray-700 flex items-center gap-x-1 hover:text-gray-950">
                <i class='bx bxs-pie-chart-alt-2 text-xl'></i>
                <p>Program</p>
            </a>
            <a nav-link {{ $slug === 'store' ? 'active' : '' }}" aria-current="page" href="/app/store"
                class=" font-semibold text-gray-700 flex items-center gap-x-1 hover:text-gray-950">
                <i class='bx bx-store text-xl'></i>
                <p>Store</p>
            </a>
            <a nav-link {{ $slug === 'blog' ? 'active' : '' }}" aria-current="page" href="/app/blog"
                class=" font-semibold text-gray-700 flex items-center gap-x-1 hover:text-gray-950">
                <i class='bx bxl-blogger text-xl'></i>
                <p>Blog</p>
            </a>
            <a nav-link {{ $slug === 'fitur' ? 'active' : '' }}" aria-current="page" href="/app/fitur"
                class=" font-semibold text-gray-700 flex items-center gap-x-1 hover:text-gray-950">
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                    <div class="space-y-2 py-6">
                        <a href="/"
                            class="-mx-3 flex items-center gap-x-2 rounded-lg px-3 py-2 font-semibold text-gray-900 hover:bg-gray-50">
