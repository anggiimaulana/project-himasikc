        ...
        <div class="flex flex-col lg:flex-row lg:justify-between gap-16">
            ...
            <div class="lg:w-2/5">
                <div class="flex items-center space-x-4">
                    <img src="{{ asset('assets/logo-himasikc.jpg') }}" alt="Logo Himasikc" class="h-10 lg:h-12 w-auto">
                    <h2 class="text-amber-500 font-bold text-xl hover:text-amber-300">HIMA-SIKC 2024</h2>
                </div>
                ...
                <div class="md:w-1/2">
                    ...
                    <form action="">
                        ...
                        <input type="submit" name="submit" id="submit" value="Kirim"
                            class="flex bg-amber-500 hover:bg-amber-300 hover:text-white text-white font-semibold py-2 px-5 rounded mt-4">
                    </form>
                </div>
            </div>
        </div>
