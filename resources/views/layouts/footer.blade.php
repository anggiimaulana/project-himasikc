    ...
    <div class="mx-auto px-6 lg:px-14">
        <div class="flex flex-col lg:flex-row lg:justify-between gap-16">
            ...
            <div class="lg:w-1/4 flex flex-col items-start space-y-4">
                <img src="{{ asset('assets/logo-himasikc.jpg') }}" alt="Logo Himasikc" class="h-10 w-auto">
            ...
            <div class="lg:w-3/4 flex flex-col lg:flex-row lg:justify-between lg:gap-32 gap-8 lg:pt-12">
                <div class="lg:w-1/3">
                ...
                <div class="lg:w-2/3">
                    ...
                    <form action="">
                        <textarea class="px-2 border-2 border-gray-300 rounded-md w-full lg:max-w-lg" name="kritikSaran" id="kritikSaran"
