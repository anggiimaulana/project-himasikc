        ...
        <div class="pt-16 lg:pt-24 sm:px-10 lg:px-16 mx-auto">
            ...
            <div class="relative h-screen flex flex-col items-center justify-center text-yellow-500">
                ...
                <div class="flex">
                    <form action="https://www.google.co.jp/search" method="GET" class="flex w-full">
                        <input name=""
                            ...
                            placeholder="Cari Informasi" type="text" />
                        <button type="submit"
                            class="px-4 py-2 bg-gray-800 text-white rounded-r-md hover:bg-gray-700 focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M11 3a8 8 0 00-8 8 8 8 0 0014.32 5.9l4.38 4.38a1 1 0 001.42-1.42l-4.38-4.38A8 8 0 0011 3z" />
                            </svg>
                        </button>
                    </form>
                </div>
                <div class="mt-4 flex space-x-4 justify-center">
                    ...
                    <a href="#" class="px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-600">HIMA-SIKC
                        INFO</a>
                    <a href="#" class="px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-600">HIMA-SIKC
                        BERITA</a>
                </div>
                ...
                @php
                    $blogs = [
                        [
                            ...
                            'image' =>
                                'https://storage.googleapis.com/a1aa/image/2FFoepXwXZy5NSbxmOoe5iE31r0hLxDnJ76xS1Qt5Y8bFfgnA.jpg',
                            'profile' =>
                                'https://storage.googleapis.com/a1aa/image/FeiNc2TRBtVUfkbnrsWOfzXfA0UeY4L5ZEdqf62eh1r0siP4JA.jpg',
                        ],
                        [
                    ...
                    <div class="mt-8 flex flex-col md:flex-row">
                        ...
                        <div class="md:w-2/3 md:pl-6 mt-4 md:mt-0">
                            <div class="flex items-center text-gray-500 text-sm">
                                ...
                                <span
                                    class="bg-gray-100 text-gray-800 px-2 py-1 rounded-full">{{ $blog['category'] }}</span>
                            </div>
                            <h2 class="mt-2 text-2xl font-semibold text-gray-900">{{ $blog['title'] }}</h2>
                            <p class="mt-2 text-gray-500">{{ $blog['description'] }}</p>
                            <div class="mt-4 flex items-center">
                                <img alt="Profile picture of {{ $blog['author'] }}" class="h-10 w-10 rounded-full"
                                    src="{{ $blog['profile'] }}" />
                                <div class="ml-3">
                    ...
                    @php
                        $articles = [
                            [
                                ...
                                'category' => 'HIMA-SIKC',
                                'description' =>
                                    'Hai hai hai! Kalian sudah tahu gak nih? Ada teknologi AI yang bisa melacak...',
                                'image' =>
                                    'https://storage.googleapis.com/a1aa/image/2FFoepXwXZy5NSbxmOoe5iE31r0hLxDnJ76xS1Qt5Y8bFfgnA.jpg',
                    ...
                    @foreach ($articles as $article)
                        <div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                @isset($article['link'])
                                    <a href="{{ $article['link'] }}" class="text-yellow-500 hover:underline mt-3 block">Baca
                                        Selengkapnya</a>
                                @endisset
                            </div>
                        </div>
